...
/**
 * Reference data for the role_has_permissions table, generated from install/database.sql.
 *
 * Primary keys are written explicitly because other seeded tables reference them by id.
 */
class RoleHasPermissionsSeeder extends InstallSeeder
{
    public function run(): void
    {
        $this->insertRows('role_has_permissions', [
