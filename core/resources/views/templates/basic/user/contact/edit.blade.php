                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form--control form-two" name="city"
                                        placeholder="@lang('Enter city')" required
                                        value="{{ old('city', $contact?->address?->city ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form--control form-two" name="state"
                                        placeholder="@lang('Enter state')" required
                                        value="{{ old('state', $contact?->address?->state ?? '') }}">
                                </div>
                            </div>

                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="label-two">@lang('Post code')</label>
                                    <input type="text" class="form--control form-two" name="post_code"
                                        placeholder="@lang('Enter post code')" required
                                        value="{{ old('post_code', $contact?->address?->post_code ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form--control form-two" name="address"
                                        placeholder="@lang('Enter address')" required
                                        value="{{ old('address', $contact?->address?->address ?? '') }}">
                                </div>
                            </div>
