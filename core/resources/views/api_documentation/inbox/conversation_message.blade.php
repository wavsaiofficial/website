<div id="conversation-messages" class="content__item">
    {{-- Preview (curl) --}}
...
curl_setopt_array($curl, array(
  CURLOPT_URL => '{{ $externalAPiBaseURL }}/inbox/conversation-messages/{conversationId}',
  ...
  CURLOPT_HTTPHEADER => array(
    'client-id: ci_ZYOX6A6Q7A989GIG8NC8',
    'client-secret: cs_BDCSEMB9WDO4MQJ4EFWP',
    'Cookie: XSRF-TOKEN=em1Qpx9uUDG5oZmWHREMnJzC5f9qvHmyhvgl7LLx; _session=FM5TA9anePD2UjcIfgm8erXWfyk5slk7Pwf22qHZ'
  ),
));
...
echo $response;
    ...
    <div class="content__inner">
        ...
        <div class="content-info intro">
            <h1 class="content-title">@lang('Conversation Messages')</h1>
            <p class="content-desc">
                @lang('Fetch all messages of a specific conversation along with contact and media related information.')
            </p>
        </div>
        ...
        <div class="content-info-api">
            ...
            <div class="content-info-url">
                /external-api/inbox/conversation-messages/{conversation_id}
            </div>
        ...
        <h4 class="content-title">@lang('URL Parameters')</h4>
        <table class="doc-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>integer</td>
                    <td>@lang('Unique ID of the conversation')</td>
                </tr>
            </tbody>
        </table>
