<div id="conversation-list" class="content__item">
...
echo $response;
    ...
    <div class="content__inner">
        <div class="content-info intro">
            <h1 class="content-title">@lang('Conversation List')</h1>
            <p class="content-desc">
                @lang('Retrieve a paginated list of conversations for the authenticated user, including contact info and conversation status.')
            </p>
        </div>
        ...
        <table class="doc-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        @lang('Filter conversations by status. Use below value for the filter conversation via status.')
                        Done = 1;
                        Pending = 2;
                        Important = 3;
                        Unread = 4;
