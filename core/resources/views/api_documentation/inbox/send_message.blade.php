<div id="send-message" class="content__item">
...
echo $response;
    ...
    <div class="content__inner">
        <div class="content-info intro">
            <h1 class="content-title">@lang('Send Message')</h1>
            <p class="content-desc">
                @lang('Send WhatsApp messages to a mobile number. This endpoint supports text, media, location, interactive lists, CTA URLs, and e-commerce messages. If no existing contact or conversation is found for the provided phone number, a new contact and conversation will be created automatically.')
            </p>
        ...
        <table class="doc-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>string</td>
                    <td>Conditional</td>
                    <td>@lang('Text message body. Required if no media, location, or interactive data is provided')</td>
                </tr>
                <tr>
                    <td><code>image</code></td>
                    <td>file</td>
                    <td>No</td>
                    <td>@lang('Image file (jpg, jpeg, png – max 5MB)')</td>
                </tr>
                <tr>
                    <td><code>document</code></td>
                    <td>file</td>
                    <td>No</td>
                    <td>@lang('Document file (pdf, doc, docx – max 100MB)')</td>
                </tr>
                <tr>
                    <td><code>video</code></td>
                    <td>file</td>
                    <td>No</td>
                    <td>@lang('Video file (mp4 – max 16MB)')</td>
                </tr>
                <tr>
                    <td><code>audio</code></td>
                    <td>file</td>
                    <td>No</td>
                    <td>@lang('Audio file – max 16MB')</td>
                </tr>
                <tr>
                    <td><code>latitude</code></td>
                    <td>decimal</td>
                    <td>Conditional</td>
                    <td>@lang('Latitude for location message')</td>
                </tr>
                <tr>
                    <td><code>longitude</code></td>
                    <td>decimal</td>
                    <td>Conditional</td>
                    <td>@lang('Longitude for location message')</td>
                </tr>
                <tr>
                    <td><code>cta_url_id</code></td>
                    <td>integer</td>
                    <td>No</td>
                    <td>@lang('CTA URL ID for interactive button messages')</td>
                </tr>
                <tr>
                    <td><code>interactive_list_id</code></td>
                    <td>integer</td>
                    <td>No</td>
                    <td>@lang('Interactive list ID')</td>
                </tr>
            </tbody>
        </table>
        ...
        <p>@lang('At least one message type must be provided.')</p>
        <p>@lang('Interactive messages require an active plan.')</p>
        <p>@lang('Blocked contacts cannot send or receive messages.')</p>
    </div>
</div>