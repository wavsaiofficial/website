<div id="change-conversation-status" class="content__item">
...
curl_setopt_array($curl, array(
  CURLOPT_URL => '{{ $externalAPiBaseURL }}/inbox/change-conversation-status/2',
...
echo $response;
    ...
    <div class="content__inner">
        <div class="content-info intro">
            <h1 class="content-title">@lang('Change Conversation Status')</h1>
            <p class="content-desc">
                @lang('Update the status of a conversation such as pending, done, or important. Here Done = 1, Pending = 2 and Important = 3,UnRead=4')
            </p>
        </div>

        <div class="content-info-api">
            <div class="content-info-badge badge badge-warning">POST</div>
