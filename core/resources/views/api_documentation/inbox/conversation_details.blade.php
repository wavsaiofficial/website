<div id="conversation-details" class="content__item">
...
curl_setopt_array($curl, array(
  CURLOPT_URL => '{{$externalAPiBaseURL}}/inbox/conversation-details/2',
...
echo $response;
    ...
    <div class="content__inner">
        <div class="content-info intro">
            <h1 class="content-title">@lang('Conversation Details')</h1>
            <p class="content-desc">
                @lang('Retrieve complete details of a conversation including contact information, notes, tags, and list associations.')
            </p>
        </div>
        ...
        <div class="content-info-api">
            ...
            <div class="content-info-url">
                /external-api/inbox/conversation-details/{conversation_id}
            </div>
