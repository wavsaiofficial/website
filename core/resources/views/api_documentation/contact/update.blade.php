<div id="contact-update" class="content__item">
    {{-- CURL Preview --}}
...
echo $response;
    ...
    <div class="content__inner">
        <div class="content-info intro">
            <h1 class="content-title">@lang('Update Contact')</h1>
            <p class="content-desc">
                @lang('This endpoint allows you to update an existing contact. You only need to send the fields you want to modify. Any field not included in the request will remain unchanged.')
            </p>
        </div>
