<div id="contact-delete" class="content__item">
    {{-- CURL Preview --}}
...
echo $response;
    ...
    <div class="content__inner">
        <div class="content-info intro">
            <h1 class="content-title">@lang('Delete Contact')</h1>
            <p class="content-desc">
                @lang('This endpoint allows you to delete a contact by its unique ID. Deletion may be restricted if the contact has associated messages or is blocked.')
            </p>
        </div>

        <div class="content-info-api">
            <div class="content-info-badge badge badge-danger">DELETE</div>
