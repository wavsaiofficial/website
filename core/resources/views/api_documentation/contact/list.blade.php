<div id="contact-list" class="content__item">
...
echo $response;
    ...
    <div class="content__inner">
        <div class="content-info intro">
            <h1 class="content-title">Get Contact List</h1>
            <p class="content-desc">
                This endpoint allows you to retrieve a complete list of contacts associated with your
                {{ gs('site_name') }} account.
            </p>
        </div>
        ...
        <div>
            <h5>@lang('Query Parameters')</h4>
                <p>
                    @lang('Query parameters that allow you to customize the API response.')
                </p>
                <table class="doc-table">
                    ...
                    <tbody>
                        <tr>
                            <td><code>@lang('page')</code></td>
                            <td>
                                @lang('Specifies the page number to retrieve.')
                            </td>
                            <td>
                        ...
                        <tr>
                            <td><code>@lang('paginate')</code></td>
                            <td>
                                @lang('Defines the number of items returned per page.')
                            </td>
                            <td>
                                <span class="badge bg-success">@lang('No')</span>
                            </td>
                        ...
                        <tr>
                            <td><code>@lang('search')</code></td>
                            <td>
                                @lang('Searches for contacts by firstname, lastname or mobile number.')
                            </td>
                            <td>
                                <span class="badge bg-success">@lang('No')</span>
                            </td>
